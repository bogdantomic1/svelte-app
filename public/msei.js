...
(function (global, factory) {
  ...
  function __extendsFn(d, b) {
    ...
    d[strShimPrototype] =
      b === null
        ? objCreateFn(b)
        : ((__[strShimPrototype] = b[strShimPrototype]), new __());
  }
  ...
  function hasJSON() {
    return Boolean(
      (typeof JSON === strObject && JSON) || getGlobalInst(strJSON) !== null,
    );
  }
  /**
  ...
  var CoreUtils = /** @class */ (function () {
    ...
    CoreUtils.arrIndexOf = function (arr, searchElement, fromIndex) {
      ...
      for (
        var lp = Math.max(from >= 0 ? from : len - Math.abs(from), 0);
        lp < len;
        lp++
      ) {
    ...
    CoreUtils.newId = function (maxLength) {
      ...
      while (result.length < maxLength) {
        ...
        if (chars === 5) {
          ...
          number =
            (((CoreUtils.random32() << 2) & 0xffffffff) | (number & 0x03)) >>>
            0;
    ...
    CoreUtils.randomValue = function (maxValue) {
      if (maxValue > 0) {
        return (
          Math.floor((CoreUtils.random32() / MaxUInt32) * (maxValue + 1)) >>> 0
        );
      }
      return 0;
    };
  ...
  function _getObjProto(target) {
    if (target) {
      ...
      var newProto =
        target[str__Proto] || target[Prototype] || target[Constructor];
      if (newProto) {
        return newProto;
      }
    }
  ...
  function _isDynamicCandidate(target, funcName, skipOwn) {
    return (
      ...
      typeof target[funcName] === strFunction$1 &&
      (skipOwn || _hasOwnProperty$1(target, funcName))
    );
  }
  /**
  ...
  function _getBaseFuncs(classProto, thisTarget, instFuncs, useBaseInst) {
    function _instFuncProxy(target, funcHost, funcName) {
      ...
      if (theFunc[DynProxyTag] && useBaseInst) {
        ...
        if (instFuncTable[DynAllowInstChkTag] !== false) {
          theFunc =
            (instFuncTable[funcHost[DynClassName]] || {})[funcName] || theFunc;
        }
      }
      return function () {
    ...
    while (
      baseProto &&
      !_isObjectArrayOrFunctionPrototype(baseProto) &&
      !_hasVisited(visited, baseProto)
    ) {
      ...
      _forEachProp(baseProto, function (name) {
        ...
        if (
          !baseFuncs[name] &&
          _isDynamicCandidate(baseProto, name, !_objGetPrototypeOf)
        ) {
          // Create an instance callback for passing the base function to the caller
    ...
    if (target && _hasOwnProperty$1(proto, DynClassName)) {
      ...
      if (
        ...
        while (
          canAddInst &&
          objProto &&
          !_isObjectArrayOrFunctionPrototype(objProto) &&
          !_hasVisited(visited, objProto)
        ) {
  ...
  function _populatePrototype(
    ...
    function _createDynamicPrototype(proto, funcName) {
      var dynProtoProxy = function () {
        ...
        var instFunc =
          _getInstFunc(this, funcName, proto, dynProtoProxy) ||
          _getProtoFunc(funcName, proto, dynProtoProxy);
    ...
    if (!_isObjectOrArrayPrototype(proto)) {
      var instFuncTable = (target[DynInstFuncTable] =
        target[DynInstFuncTable] || {});
      var instFuncs_1 = (instFuncTable[className] =
        instFuncTable[className] || {}); // fetch and assign if as it may not exist yet
      ...
      _forEachProp(target, function (name) {
        ...
        if (
          _isDynamicCandidate(target, name, false) &&
          target[name] !== baseInstFuncs[name]
        ) {
          ...
          if (
            !_hasOwnProperty$1(proto, name) ||
            (proto[name] && !proto[name][DynProxyTag])
          ) {
  ...
  function _getObjName(target, unknownValue) {
    ...
    return (
      ((target || {})[Constructor] || {}).name || unknownValue || UnknownValue
    );
  }
  /**
  ...
  function dynamicProto(theClass, target, delegateFunc, options) {
    ...
    if (!_checkPrototype(classProto, target)) {
      _throwTypeError(
        "[" +
          _getObjName(theClass) +
          "] is not in class hierarchy of [" +
          _getObjName(target) +
          "]",
      );
    }
    ...
    var setInstanceFunc =
      !!_objGetPrototypeOf && !!perfOptions[strSetInstFuncs];
  ...
  var DiagnosticLogger = /** @class */ (function () {
            ...
            if (!isUndefined(message) && !!message) {
              if (!isUndefined(message.message)) {
                if (isUserAct) {
                  ...
                  if (
                    !_messageLogged[messageKey] &&
                    _self.consoleLoggingLevel() >= LoggingSeverity.WARNING
                  ) {
     ...
     * @param message {_InternalLogMessage} - The log message.
     */
    DiagnosticLogger.prototype.throwInternal = function (
      severity,
      msgId,
      msg,
      properties,
     ...
     * @param message {_InternalLogMessage} - The message to log.
     */
    DiagnosticLogger.prototype.logInternalMessage = function (
      severity,
      message,
    ) {
      // @DynamicProtoStub -- DO NOT add any code as this will be removed during packaging
  ...
  var PerfEvent = /** @class */ (function () {
    function PerfEvent(name, payloadDetails, isAsync) {
      ...
      if (CoreUtils.isFunction(payloadDetails)) {
        ...
        var theDetails_1;
        accessorDefined = CoreUtils.objDefineAccessors(
          _self,
          "payload",
          function () {
      ...
      _self.getCtx = function (key) {
        if (key) {
          ...
          if (
            key === PerfEvent.ParentContextKey ||
            key === PerfEvent.ChildrenContextKey
          ) {
            return _self[key];
          }
      ...
      _self.setCtx = function (key, value) {
        if (key) {
          ...
          if (key === PerfEvent.ParentContextKey) {
            ...
            var ctx = (_self[strExecutionContextKey] =
              _self[strExecutionContextKey] || {});
            ctx[key] = value;
          }
        }
      };
          ...
          if (perfEvt) {
            if (currentActive && perfEvt.setCtx) {
              ...
              if (currentActive.getCtx && currentActive.setCtx) {
                var children = currentActive.getCtx(
                  PerfEvent.ChildrenContextKey,
                );
                if (!children) {
                  children = [];
    ...
    function ProcessTelemetryContext(plugins, config, core, startAt) {
      ...
      if (startAt !== null) {
        if (plugins && CoreUtils.isFunction(plugins.getPlugin)) {
          ...
          _nextProxy = _copyProxyChain(
            plugins,
            _self,
            startAt || plugins.getPlugin(),
          );
        } else {
      ...
      _self.createNew = function (plugins, startAt) {
        ...
        return new ProcessTelemetryContext(
          plugins || _nextProxy,
          config,
          core,
          startAt,
  ...
  var BaseTelemetryPlugin = /** @class */ (function () {
    function BaseTelemetryPlugin() {
      ...
      _self._getTelCtx = function (currentCtx) {
        ...
        if (!itemCtx) {
          var rootCtx =
            _rootCtx || new ProcessTelemetryContext(null, {}, _self.core);
      ...
      _self._baseTelInit = function (config, core, extensions, pluginChain) {
        ...
        _self.core = core;
        _rootCtx = new ProcessTelemetryContext(
          pluginChain,
          config,
          core,
          nextPlugin,
    ...
    BaseTelemetryPlugin.prototype.initialize = function (
      config,
      core,
      extensions,
      pluginChain,
  ...
  function initializePlugins(processContext, extensions) {
    ...
    while (proxy) {
      ...
      if (thePlugin) {
        ...
        if (
          !_isFunction$3(thePlugin[isInitialized]) ||
          !thePlugin[isInitialized]()
        ) {
  ...
  var ChannelController = /** @class */ (function (_super) {
        ...
        _self.initialize = function (config, core, extensions) {
          ...
          _arrForEach(_channelQueue, function (queue) {
            return initializePlugins(
              new ProcessTelemetryContext(queue, config, core),
              extensions,
            );
          });
        };
    ...
    ChannelController.prototype.initialize = function (
      config,
      core,
      extensions,
    ) {
    ...
    ChannelController._staticInit = (function () {
      ...
      _objDefineAccessors(
        ...
        "ChannelControls",
        ChannelController.prototype.getChannelControls,
      );
      _objDefineAccessors(
        ChannelController.prototype,
        "channelQueue",
  ...
  var BaseCore = /** @class */ (function () {
    function BaseCore() {
      ...
      dynamicProto(BaseCore, this, function (_self) {
        ...
        _self.initialize = function (
          ...
          _self.config = config || {};
          config.extensions = _isNullOrUndefined$2(config.extensions)
            ? []
            : config.extensions;
          // add notification to the extensions in the config so other plugins can access it
          var extConfig = (config.extensionConfig = _isNullOrUndefined$2(
          ...
          var allExtensions = [];
          allExtensions.push.apply(
            allExtensions,
            extensions.concat(config.extensions),
          );
          ...
          _arrForEach(allExtensions, function (ext) {
            if (
              _isNullOrUndefined$2(ext) ||
              _isNullOrUndefined$2(ext.initialize)
            ) {
            ...
            if (ext && extPriority) {
              if (!_isNullOrUndefined$2(extPriorities[extPriority])) {
                logger.warnToConsole(
                  "Two extensions have same priority #" +
                    extPriority +
                    " - " +
                    extPriorities[extPriority] +
                    ", " +
                    identifier,
                );
              } else {
          ...
          initializePlugins(
            new ProcessTelemetryContext([_channelController], config, _self),
            allExtensions,
          );
          initializePlugins(
            new ProcessTelemetryContext(coreExtensions, config, _self),
            allExtensions,
          );
    ...
    BaseCore.prototype.initialize = function (
      config,
      extensions,
      logger,
      notificationManager,
  ...
  var NotificationManager = /** @class */ (function () {
     ...
     */
    NotificationManager.prototype.addNotificationListener = function (
      listener,
    ) {
      // @DynamicProtoStub -- DO NOT add any code as this will be removed during packaging
    };
     ...
     * @param {INotificationListener} listener - AWTNotificationListener to remove.
     */
    NotificationManager.prototype.removeNotificationListener = function (
      listener,
    ) {
      // @DynamicProtoStub -- DO NOT add any code as this will be removed during packaging
    };
     ...
     * @param {boolean} isAsync   - A flag which identifies whether the requests are being sent in an async or sync manner.
     */
    NotificationManager.prototype.eventsSendRequest = function (
      sendReason,
      isAsync,
    ) {
      // @DynamicProtoStub -- DO NOT add any code as this will be removed during packaging
  ...
  var AppInsightsCore = /** @class */ (function (_super) {
    ...
    function AppInsightsCore() {
      ...
      dynamicProto(AppInsightsCore, _this, function (_self, _base) {
          ...
          return setInterval(function () {
            ...
            CoreUtils.arrForEach(queue, function (logMessage) {
              var item = {
                name: eventName
                  ? eventName
                  : "InternalMessageId: " + logMessage.messageId,
        ...
        function _notifyInvalidEvent(telemetryItem) {
          var manager = _self.getNotifyMgr();
          if (manager) {
            manager.eventsDiscarded(
              [telemetryItem],
              EventsDiscardedReason.InvalidEvent,
            );
          }
        }
      });
    ...
    AppInsightsCore.prototype.initialize = function (
      config,
      extensions,
      logger,
      notificationManager,
  ...
  var _ExtendedInternalMessageId = __assign(__assign({}, _InternalMessageId), {
  ...
  function sanitizeProperty(name, property, stringifyObjects) {
    ...
    if (
      ...
      _isNullOrUndefined$3(property.value) ||
      property.value === "" ||
  ...
  function useXDomainRequest() {
    if (typeof XMLHttpRequest !== undefined) {
      ...
      if (xhr) {
        var conn = new xhr();
        return Boolean(
          _isUndefined$1(conn.withCredentials) &&
  ...
  function disallowsSameSiteNone(userAgent) {
    ...
    if (
      userAgent.indexOf("CPU iPhone OS 12") !== -1 ||
    ...
    if (
      userAgent.indexOf("Macintosh; Intel Mac OS X 10_14") !== -1 &&
    ...
    if (
      userAgent.indexOf("Macintosh; Intel Mac OS X 10_14") !== -1 &&
      strEndsWith(userAgent, "AppleWebKit/605.1.15 (KHTML, like Gecko)")
    ) {
      return true;
    }
    ...
    if (
      userAgent.indexOf("UnrealEngine") !== -1 &&
    ...
    if (
      userAgent.indexOf("UCBrowser/12") !== -1 ||
      userAgent.indexOf("UCBrowser/11") !== -1
    ) {
      return true;
    }
    return false;
    ...
    if (cookieAvailable()) {
      ...
      if (loc && loc.protocol === "https:") {
        ...
        if (_uaDisallowsSameSiteNone === null) {
          _uaDisallowsSameSiteNone = disallowsSameSiteNone(
      ...
      getDocument().cookie =
        name + "=" + value + expires + "; path=/" + secureAttrib;
    }
  }
  /**
  ...
  function isValueKind(value) {
    if (
      isNumber(value) &&
      ((value >= ValueKind.NotSet &&
        value <= ValueKind.Pii_IPV4AddressLegacy) ||
        value === ValueKind.CustomerContent_GenericContent)
    ) {
      return true;
    }
    return false;
  ...
  function strEndsWith(sourceString, suffix) {
    return (
      ...
      suffix !== undefined &&
      sourceString.indexOf(suffix, sourceString.length - suffix.length) !== -1
    );
  }
  ...
  var AppInsightsCore$1 = /** @class */ (function (_super) {
            ...
            function () {
              ...
              if (config) {
                ...
                if (
                  ...
                  (!propertyStorageOverride.getProperty ||
                    !propertyStorageOverride.setProperty)
                ) {
              ...
              _self.pluginVersionString =
                _self.pluginVersionStringArr.join(";");
              try {
                _base.initialize(
                  config,
                  extensions,
                ...
                _self.logger.throwInternal(
                  LoggingSeverity.CRITICAL,
                  _ExtendedInternalMessageId.ErrorProvidedChannels,
     ...
     */
    AppInsightsCore$$1.prototype.initialize = function (
      config,
      extensions,
      logger,
      notificationManager,
  ...
  var BaseCore$1 = /** @class */ (function (_super) {
     ...
     * @param extensions - An array of extensions that are to be used by the core.
     */
    BaseCore$$1.prototype.initialize = function (
      config,
      extensions,
      logger,
      notificationManager,
   ...
   */
  function _createPromiseAllOnResolvedFunction(
    values,
    index,
    resolvedCallback,
  ) {
        ...
        _queue.push(function () {
          ...
          try {
            ...
            if (_state === 1 /* Resolved */) {
              value = _isFunction$4(onResolved)
                ? onResolved(_settledValue)
                : _settledValue;
            } else {
              value = _isFunction$4(onRejected)
                ? onRejected(_settledValue)
                : _settledValue;
            }
        ...
        try {
          ...
          for (var lp = 0; lp < iterable.length; lp++) {
            ...
            if (item && _isFunction$4(item.then)) {
              pending_2++;
              item.then(
                _createPromiseAllOnResolvedFunction(values_1, lp, function () {
                  if (--pending_2 === 0) {
                    resolve(values_1);
                  }
                }),
  ...
  var ESPromiseScheduler = /** @class */ (function () {
    function ESPromiseScheduler(name, diagLog) {
      ...
      dynamicProto(ESPromiseScheduler, this, function (_this) {
        ...
        _this.scheduleEvent = function (startEventAction, eventName, timeout) {
          ...
          if (!_lastEvent) {
            ...
            newScheduledEvent.evt = _waitForPreviousEvent(
              newScheduledEvent,
              _lastEvent,
            );
          }
          ...
          function _cleanup(eventId, completed) {
            ...
            if (removed) {
              ...
              if (completed) {
                if (!toQueue) {
                  _debugLog(
                    "Promise [" + eventId + "] Complete -- " + tm + " ms",
                  );
                } else {
                  _warnLog(
                    "Timed out event [" +
              ...
              _debugLog(
                "Failed to remove [" + eventId + "] from running queue",
              );
            }
            ...
            startResult.then(
              function (value) {
                if (value instanceof ESPromise) {
                  ...
                  _debugLog(
                    "Event [" + eventId + "] returned a promise -- waiting",
                  );
                  _waitForFinalResult(
                    eventId,
                    value,
          ...
          function _startWaitingEvent(eventDetails) {
            ...
            if (eventDetails.isAborted) {
              return ESPromise.reject(
                new Error("[" + uniqueId + "] was aborted"),
              );
            }
            ...
            var waitEvent = new ESPromise(function (waitResolve, waitReject) {
              ...
              waitForEvent.evt.then(
                function (value) {
                  ...
                  _startWaitingEvent(eventDetails).then(
                    waitResolve,
                    waitReject,
                  );
                },
      ...
      function _debugLog(message) {
        ...
        if (global && global["QUnit"]) {
          ...
          console &&
            console.log(
              "ESPromiseScheduler[" + _scheduledName + "] " + message,
            );
        }
      }
      function _warnLog(message) {
        diagLog &&
          diagLog.warnToConsole(
            "ESPromiseScheduler[" + _scheduledName + "] " + message,
          );
      }
    }
     ...
     */
    ESPromiseScheduler.prototype.scheduleEvent = function (
      startEventAction,
      eventName,
      timeout,
    ) {
  ...
  var MaxBeaconRecordSize = Math.min(
    MaxRecordSize,
    BeaconRequestSizeLimitBytes,
  );
    ...
    function Serializer(
      ...
      dynamicProto(Serializer, this, function (_self) {
            ...
            doPerf(
              ...
              function () {
                ...
                if (sizeExceeded && sizeExceeded.length > 0) {
                  payload.sizeExceed.push(
                    EventBatch.create(theBatch.iKey(), sizeExceeded),
                  );
              ...
              function () {
                return {
                  payload: payload,
                  theBatch: { iKey: theBatch.iKey(), evts: theBatch.events() },
        ...
        function _isReservedField(path, name) {
          ...
          if (result === undefined) {
            result = false;
            if (path.indexOf("ext.metadata") === 0) {
              // Using indexOf === 0 as a replacement for startsWith() which is not available on IE
              // Do not allow the changing of fields located in the ext.metadata extension
              result = true;
            } else if (path.indexOf("ext.web") === 0) {
              // Using indexOf === 0 as a replacement for startsWith() which is not available on IE
          ...
          objForEachKey(srcObj, function (key, srcValue) {
            ...
            if (isValueAssigned(srcValue)) {
              ...
              if (
                !isReserved &&
                _theSanitizer &&
                _theSanitizer.handleField(path, name_1)
              ) {
                prop = _theSanitizer.value(
                  path,
                  name_1,
                  srcValue,
                  stringifyObjects,
  ...
  function _addJSONPropertyMetaData(json, propKeys, name, propertyValue) {
    if (propertyValue && json) {
      var encodedTypeValue = getCommonSchemaMetaData(
        propertyValue.value,
        propertyValue.kind,
  ...
  var RetryPolicy = /** @class */ (function () {
    ...
    RetryPolicy.getMillisToBackoffForRetry = function (retriesSoFar) {
      ...
      var randomBackoff =
        Math.floor(Math.random() * (maxBackoff - minBackoff)) + minBackoff;
    ...
    function KillSwitch() {
      ...
      dynamicProto(KillSwitch, this, function (_self) {
          ...
          if (killTokens && killDuration) {
            try {
              ...
              for (var i = 0; i < killedTokens.length; ++i) {
                _killedTokenDictionary[killedTokens[i]] =
                  CoreUtils.dateNow() + durationMs;
              }
            } catch (ex) {
              return [];
            }
        ...
        _self.isTenantKilled = function (tenantToken) {
          ...
          if (
            killDictionary[name] !== undefined &&
            killDictionary[name] > CoreUtils.dateNow()
          ) {
            return true;
          }
  ...
  var HttpManager = /** @class */ (function () {
    ...
    function HttpManager(
      ...
      var _urlString =
        "?cors=true&content-type=application/x-json-stream&client-id=NO_AUTH&client-version=" +
        FullVersionString;
      ...
      dynamicProto(HttpManager, this, function (_self) {
        ...
        _self.initialize = function (
          ...
          if (!_httpInterface) {
            ...
            if (
              location_1 &&
              location_1.protocol &&
              location_1.protocol.toLowerCase() === "file:"
            ) {
        ...
        function _xhrSendPost(payload, oncomplete, sync) {
          ...
          function _getAllResponseHeaders(xhr) {
            ...
            if (!xhr.getAllResponseHeaders) {
              ...
              theHeaders = _appendHeader(
                theHeaders,
                xhr,
                strKillDurationHeader,
              );
              theHeaders = _appendHeader(
                theHeaders,
                xhr,
                strKillDurationSecondsHeader,
              );
            } else {
          ...
          try {
            ...
            _postManager
              ...
              .throwInternal(
                ...
                _ExtendedInternalMessageId.SendPostOnCompleteFailure,
                e,
              );
          }
        }
        ...
        _self.canSendRequest = function () {
          return (
            _hasIdleConnection() && _clockSkewManager.allowRequestSending()
          );
        };
        _self.sendQueuedRequests = function (
          sendReason,
          isAsync,
          useSendBeacon,
        ) {
        ...
        _self.isCompletelyIdle = function () {
          return (
            !_paused && _outstandingRequests === 0 && _batchQueue.length === 0
          );
        };
         ...
         */
        _self.sendSynchronousBatch = function (
          batch,
          sendReason,
          useSendBeacon,
        ) {
        ...
        function _canSendPayload(theBatches, isSync, retryCnt) {
          ...
          if (
            ...
            result =
              isSync ||
              (_hasIdleConnection() &&
                (retryCnt > 0 || _clockSkewManager.allowRequestSending()));
          }
          return result;
        }
        ...
        function _sendBatches(
          ...
          doPerf(
              ...
              while (_canSendPayload(theBatches, isSynchronous, retryCount)) {
                ...
                if (theBatch && theBatch.count() > 0) {
                  if (!_killSwitch.isTenantKilled(theBatch.iKey())) {
                    ...
                    thePayload =
                      thePayload ||
                      _serializer.createPayload(
                        retryCount,
                        isTeardown,
                        isSynchronous,
                        useSendBeacon && _canUseSendBeaconApi(),
                      );
                    // Add the batch to the current payload
                    if (
                      !_serializer.appendPayload(
                        thePayload,
                        theBatch,
                        maxEventsPerBatch,
                      )
            ...
            function () {
              return {
                batches: _createDebugBatches(orgBatches),
        ...
        function _buildQueryString(thePayload) {
          ...
          if (_clockSkewManager.shouldAddClockSkewHeaders()) {
            urlString +=
              ...
              _clockSkewManager.getClockSkewHeaderValue();
          }
          if (_core.getWParam) {
          ...
          for (var i = 0; i < _queryStringParameters.length; i++) {
            urlString +=
              "&" +
              _queryStringParameters[i].name +
              "=" +
              _queryStringParameters[i].value;
          }
          return urlString;
        }
        ...
        function _doPayloadSend(
          ...
          if (
            thePayload &&
            thePayload.payloadBlob &&
            thePayload.payloadBlob.length > 0
          ) {
              ...
              function () {
                ...
                arrForEach(thePayload.batches, function (theBatch) {
                  arrForEach(theBatch.events(), function (telemetryItem) {
                    if (_enableEventTimings) {
                      var timings = (telemetryItem.timings =
                        telemetryItem.timings || {});
                      _setTimingValue(
                        timings,
                        "sendEventStart",
                        sendEventStart_1,
                    ...
                    telemetryItem[strSendAttempt_1] > 0
                      ? telemetryItem[strSendAttempt_1]++
                      : (telemetryItem[strSendAttempt_1] = 1);
                  });
                });
                // Note: always sending this notification in a synchronous manner.
                _sendBatchesNotification(
                  thePayload.batches,
                  1000 /* SendingUndefined */ +
                    (sendReason || 0) /* Undefined */,
                  thePayload.isSync,
                  true,
                );
                ...
                if (_canUseSendBeaconApi() && thePayload.isBeacon) {
                  ...
                  sender = function (payload) {
                    ...
                    try {
                      _httpInterface.sendPOST(
                        payload,
                        onComplete,
                        thePayload.isTeardown || thePayload.isSync,
                      );
                      if (_self.sendListener) {
          ...
          _sendBatchesNotification(
            thePayload.sizeExceed,
            8003 /* SizeLimitExceeded */,
            thePayload.isSync,
          );
        }
        function _sendUsingBeacons(payload, thePayload, sendReason) {
          ...
          try {
            ...
            _postManager
              .diagLog()
              .warnToConsole(
                "Failed to send telemetry using sendBeacon API. Ex:" + ex,
              );
          }
        }
        ...
        function _retryRequestIfNeeded(
          status,
          headers,
          thePayload,
          sendReason,
          ...
          try {
            ...
            if (typeof status !== strUndefined$1) {
              if (headers) {
                ...
                var killDuration =
                  headers[strKillDurationHeader] ||
                  headers["kill-duration-seconds"];
                arrForEach(
                  _killSwitch.setKillSwitchTenants(
                    headers[strKillTokensHeader],
                    killDuration,
                  ),
                  function (killToken) {
                    arrForEach(thePayload.batches, function (theBatch) {
              ...
              if (
                !RetryPolicy.shouldRetryForStatus(status) ||
                thePayload.numEvents <= 0
              ) {
                  ...
                  _doAction(
                    function () {
                      ...
                      _sendBatches(
                        ...
                        thePayload.isSync,
                        5 /* SendRequestReason.Retry */,
                        thePayload.isBeacon,
                      );
                    },
                    true,
                    RetryPolicy.getMillisToBackoffForRetry(retryCount_1),
                  );
                } else {
                  backOffTrans = true;
                }
        ...
        function _handleCollectorResponse(responseText) {
          ...
          try {
            ...
            if (responseText) {
              ...
              if (
                isValueAssigned(response.webResult) &&
                isValueAssigned(response.webResult.msfpc)
              ) {
                // Set cookie
        ...
        function _sendBatchesNotification(
          theBatches,
          batchReason,
          isSyncRequest,
          sendSync,
        ...
        function _getNotificationAction(reason) {
          ...
          if (!isValueAssigned(action)) {
            action = strOther;
            if (
              reason >= 9000 /* ResponseFailure */ &&
              reason <= 9999 /* ResponseFailureMax */
            ) {
              action = strResponseFail;
            } else if (
              reason >= 8000 /* EventsDropped */ &&
              reason <= 8999 /* EventsDroppedMax */
            ) {
              action = strDropped;
            } else if (
              reason >= 1000 /* SendingUndefined */ &&
              reason <= 1999 /* SendingEventMax */
            ) {
              action = strSending;
            }
          }
   ...
   * (Microsoft Internal Only)
   */
  var FlushCheckTimer = 0.25; // This needs to be in seconds, so this is 250ms
      ...
      dynamicProto(PostChannel, _this, function (_self, _base) {
        ...
        _self.initialize = function (coreConfig, core, extensions) {
          doPerf(
            ...
            function () {
              ...
              coreConfig.extensionConfig[_self.identifier] =
                coreConfig.extensionConfig[_self.identifier] || {};
              _config = ctx.getExtCfg(_self.identifier);
              _self._setTimeoutOverride = _config.setTimeoutOverride
                ? _config.setTimeoutOverride
                : setTimeout.bind(globalContext);
              _self._clearTimeoutOverride = _config.clearTimeoutOverride
                ? _config.clearTimeoutOverride
                : clearTimeout.bind(globalContext);
              ...
              if (isValueAssigned(coreConfig.anonCookieName)) {
                _httpManager.addQueryStringParameter(
                  "anoncknm",
                  coreConfig.anonCookieName,
                );
              }
              _httpManager.sendHook = _config.payloadPreprocessor;
              _httpManager.sendListener = _config.payloadListener;
              // Override endpointUrl if provided in Post config
              var endpointUrl = _config.overrideEndpointUrl
                ? _config.overrideEndpointUrl
                : coreConfig.endpointUrl;
              _self._notificationManager =
                coreConfig.extensionConfig.NotificationManager;
              ...
              addPageUnloadEventListener(function () {
        ...
        _self.processTelemetry = function (ev, itemCtx) {
          ...
          if (channelConfig) {
            ...
            disableTelemetry =
              disableTelemetry || !!channelConfig.disableTelemetry;
          }
          var event = ev;
        ...
        function _addEventToQueues(event, append) {
          ...
          if (eventDropped) {
            ...
            _notifyEvents(
              strEventsDiscarded,
              [event],
              EventsDiscardedReason.QueueFull,
            );
          }
        }
        _self.setEventQueueLimits = function (eventLimit, autoFlushLimit) {
          ...
          if (!doFlush && _autoFlushBatchLimit > 0) {
            ...
            for (
              var latency = EventLatency.Normal;
              !doFlush && latency <= EventLatency.RealTime;
              latency++
            ) {
        ...
        _self._setTransmitProfile = function (profileName) {
          if (
            ...
            _profiles[profileName] !== undefined
          ) {
            _clearScheduledTimer();
            _currentProfile = profileName;
            _scheduleTimer();
         ...
         */
        function _sendEventsForLatencyAndAbove(
          latency,
          sendReason,
          isAsync,
          useSendBeacon,
        ...
        function _scheduleTimer() {
          ...
          if (
            _delayedBatchSendLatency >= 0 &&
            _queueBatches(_delayedBatchSendLatency, _delayedBatchReason, true)
          ) {
        ...
        function _createTimer(theTimerFunc, timeOut) {
          ...
          if (_currentBackoffCount) {
            timerMultiplier = RetryPolicy.getMillisToBackoffForRetry(
              _currentBackoffCount - 1,
            );
          }
          return _self._setTimeoutOverride(
            theTimerFunc,
            timeOut * timerMultiplier,
          );
        }
        ...
        function _performAutoFlush(isAsync, doFlush) {
          ...
          if (_httpManager.canSendRequest() && !_currentBackoffCount) {
            if (
              ...
              _queueSize > _autoFlushEventsLimit
            ) {
              // Force flushing
              doFlush = true;
            }
            ...
            if (append && event.sendAttempt === 0) {
              ...
              _performAutoFlush(
                ...
                _autoFlushBatchLimit > 0 &&
                  eventBatch.count() >= _autoFlushBatchLimit,
              );
            }
            return true;
          }
        ...
        function _queueBatches(latency, sendReason, isAsync) {
          ...
          if (!isAsync || _httpManager.canSendRequest()) {
            doPerf(
              ...
              function () {
                  ...
                  if (batchQueue && batchQueue.batches) {
                    arrForEach(batchQueue.batches, function (theBatch) {
                      ...
                      if (!_httpManager.addBatch(theBatch)) {
                        ...
                        eventsQueued =
                          eventsQueued || (theBatch && theBatch.count() > 0);
                      }
                ...
                if (droppedEvents.length > 0) {
                  _notifyEvents(
                    strEventsDiscarded,
                    droppedEvents,
                    EventsDiscardedReason.KillSwitch,
                  );
                }
              ...
              function () {
                return { latency: latency, sendReason: sendReason };
              },
              isAsync,
            );
          } else {
            ...
            _delayedBatchSendLatency =
              _delayedBatchSendLatency >= 0
                ? Math.min(_delayedBatchSendLatency, latency)
                : latency;
        ...
        function _flushImpl(callback, sendReason) {
          ...
          _waitForIdleManager(function () {
            ...
            if (_flushCallbackQueue.length > 0) {
              _flushCallbackTimerId = _createTimer(function () {
                return _flushImpl(_flushCallbackQueue.shift(), sendReason);
              }, 0);
            } else {
          ...
          if (batches && batches.length > 0) {
            arrForEach(batches, function (theBatch) {
              if (theBatch && theBatch.count() > 0) {
                _callNotification(
                  evtName,
                  [theBatch.events()].concat(extraArgs),
                );
              }
            });
          }
        ...
        function _sendingEvent(batches, reason, isSyncRequest) {
          if (batches && batches.length > 0) {
            _callNotification("eventsSendRequest", [
              reason >= 1000 /* SendingUndefined */ &&
              reason <= 1999 /* SendingEventMax */
                ? reason - 1000 /* SendingUndefined */
                : 0 /* Undefined */,
        ...
        function _setAutoLimits() {
          if (!_config || !_config.disableAutoBatchFlushLimit) {
            _autoFlushBatchLimit = Math.max(
              MaxNumberEventPerBatch * (MaxConnections + 1),
              _queueSizeLimit / 6,
            );
          } else {
            _autoFlushBatchLimit = 0;
  ...
  function __extends$1(d, b) {
    ...
    d.prototype =
      b === null
        ? (function (obj) {
            /* ai_es3_polyfil create */ var func = Object["create"];
            if (func) {
              return func(obj);
            }
            if (obj == null) {
            ...
            if (type !== "object" && type !== "function") {
              throw new TypeError(
                "Object prototype may only be an Object:" + obj,
              );
            }
            function tmpFunc() {}
  ...
  var Properties = /** @class */ (function (_super) {
    ...
    function Properties() {
      ...
      if (windowLocation) {
        ...
        if (domain) {
          _this._domain =
            windowLocation.protocol === "file:" ? "local" : domain;
        }
      }
      return _this;
    }
    ...
    Properties.prototype.processTelemetry = function (event, itemCtx) {
      event.data[_Extensions._SignalExt][_SignalExtKeys._ExtKey][
        _SharedKeys._TimeZone
      ] = this._timeZone;
      event.data[_Extensions._SignalExt][_SignalExtKeys._ExtKey][
        _SharedKeys._Source
      ] = "Web";
      ...
      event.data[_Extensions._SignalExt][_SignalExtKeys._User][
        _UserExtKeys._LocalId
      ] = this._user.localId || this._msei;
      event.data[_Extensions._SignalExt][_SignalExtKeys._User][
        _UserExtKeys._AuthId
      ] = this._user.authId;
      event.data[_Extensions._SignalExt][_SignalExtKeys._User][
        _UserExtKeys._AuthType
      ] = this._user.authType;
      event.data[_Extensions._SignalExt][_SignalExtKeys._User][
        _UserExtKeys._Email
      ] = this._user.email;
      event.data[_Extensions._SignalExt][_SignalExtKeys._User][
        _SharedKeys._NameKey
      ] = this._user.name;
      //Pass event to session manager to process and add required session fields.
      this._sessionManager._processEvent(
        event,
        this._mseiCreated,
        event.name === _ViewEventName || event.name === _ActionEventName,
      );
   ...
   * @returns Dom element which is an anchor
   */
  function _walkUpDomChainWithElementValidation(
    el,
    validationMethod,
    validationMethodParam,
  ) {
    var element = el;
    if (element) {
  ...
  var Autocollector = /** @class */ (function () {
    ...
    Autocollector.prototype._processClick = function (clickEvent) {
      ...
      while (element && element.tagName) {
        if (
          element.control &&
          clickCaptureElements[element.control.tagName.toUpperCase()]
        ) {
        ...
        if (!clickCaptureElements[element.tagName.toUpperCase()]) {
          ...
          sendAction =
            element.tagName.toUpperCase() === "INPUT"
              ? _clickCaptureInputTypes[element.type.toUpperCase()]
              : true;
          break;
        }
      }
  ...
  var SessionManager = /** @class */ (function () {
    ...
    function SessionManager(storageManager) {
      ...
      this._session = this._parseSessionString(
        this._storageManager._getProperty(_EISessionKey),
      );
    }
    /**
     ...
     */
    SessionManager.prototype._processEvent = function (
      event,
      userCookieCreated,
      isHit,
    ) {
      ...
      if (isHit) {
        ...
        event.data[_Extensions._SignalExt][_SignalExtKeys._User][
          ...
          ? _UserStateValues._New
          : _UserStateValues._Returning;
        event.data[_Extensions._SignalExt][_SignalExtKeys._Session][
          _SessionExtKeys._Duration
        ] = eventTime - this._session.s;
      }
      event.data[_Extensions._SignalExt][_SignalExtKeys._Session][
        _SessionExtKeys._Id
      ] = this._isSessionActive(eventTime) ? this._session.i : _emptyString;
    };
    /**
    ...
    SessionManager.prototype._isSessionActive = function (time, reload) {
      ...
      return (
        this._session && isObject(this._session) && time <= this._session.e
      );
    };
    /**
     ...
     */
    SessionManager.prototype._extendOrStartSession = function (
      time,
      event,
      userCookieCreated,
    ) {
      ...
      if (!this._session || this._session.e < time) {
        if (!userCookieCreated) {
          event.data[_Extensions._SignalExt][_SignalExtKeys._User][
            _UserExtKeys._TimeSinceVisit
          ] = this._session ? time - this._session.e : _emptyString;
        }
        //start new session
        this._session = {
          i: createGuid(),
        ...
        this._session.e =
          time + extendTime < this._session.m
            ? time + extendTime
            : this._session.m;
      }
      this._storageManager._setProperty(
        _EISessionKey,
        this._getSessionString(this._session),
      );
    };
    ...
    SessionManager.prototype._getSessionString = function (session) {
      var sessionString =
        session.i + delimitter + session.s + delimitter + session.e;
  ...
  var StatsManager = /** @class */ (function () {
     ...
     */
    StatsManager.prototype._addStatForEventDiscarded = function (
      events,
      reason,
    ) {
      events = this._getNonStatsEvents(events);
    ...
    StatsManager.prototype._addStat = function (statName, value, ingestionKey) {
      if (this._isInitalized) {
        ...
        if (!this._stats[ingestionKey][statName]) {
          ...
          this._stats[ingestionKey][statName] =
            this._stats[ingestionKey][statName] + value;
        }
      }
    };
  ...
  var Analytics = /** @class */ (function () {
    ...
    Analytics.prototype.initialize = function (configuration) {
      ...
      if (!this._isInitialized) {
        ...
        this._storageDisabled = isValueAssigned(configuration.userConsent)
          ? !configuration.userConsent
          : false;
        this._storageDisabled = StorageManager._getLocalStorage()
        ...
        this._notificationManager.addNotificationListener({
          eventsSent: this._statsManager._addStatForEventSent.bind(
            this._statsManager,
          ),
          eventsDiscarded: this._statsManager._addStatForEventDiscarded.bind(
            this._statsManager,
          ),
        });
        this._applicationInsightsCore.initialize(
          coreConfig,
          [],
          null,
    ...
    Analytics.prototype.trackView = function (view) {
      if (!this._storageDisabled) {
        ...
        if (
          (this._sessionManager._isSessionActive(this._lastViewTime.getTime()),
          true)
        ) {
          this._previousView =
            this._storageManager._getProperty(_EIPreviousKey);
        }
    ...
    Analytics.prototype.trackAction = function (action, properties) {
      if (!this._storageDisabled) {
        ...
        props[_Extensions._SignalExt][_SignalExtKeys._Action][
          _ActionExtKeys._ElementId
        ] = action.elementId;
        props[_Extensions._SignalExt][_SignalExtKeys._Action][
          _SharedKeys._Class
        ] = action["class"];
        props[_Extensions._SignalExt][_SignalExtKeys._Action][
          _ActionExtKeys._Target
        ] = d(action.viewTarget);
        //Elapsed time
        props[_Extensions._SignalExt][_SignalExtKeys._Action][
          _ActionExtKeys._ElapsedTime
        ] = actionTime.getTime() - this._lastViewTime.getTime();
        ...
        if (action.viewTarget && this._properties.origin) {
          props[_Extensions._SignalExt][_SignalExtKeys._Action][
            _ActionExtKeys._IsOutbound
          ] = !action.viewTarget.startsWith(this._properties.origin);
        }
        props[_Extensions._SignalExt][_SignalExtKeys._Click] = {};
        props[_Extensions._SignalExt][_SignalExtKeys._Click][
          _ClickExtKeys._Coordinates
    ...
    Analytics.prototype._trackEvent = function (event) {
      if (this._isInitialized) {
        ...
        props[_Extensions._SignalExt][_SignalExtKeys._ExtKey][_SharedKeys._Id] =
          createGuid();
    ...
    Analytics.prototype._isValidKey = function (key) {
      ...
      return !(
        key.length < 3 ||
        key.startsWith(this._invalidSignalPrefix) ||
        key.startsWith(this._invalidSignalLongPrefix) ||
        key === _Extensions._SignalLongExt
      );
    };
    Analytics.prototype._addScreenInfo = function (props) {
      ...
      if (screen) {
        props[_Extensions._SignalExt][_SignalExtKeys._View][
          _ViewExtKeys._Height
        ] = screen.h;
        props[_Extensions._SignalExt][_SignalExtKeys._View][
          _ViewExtKeys._Width
        ] = screen.w;
        props[_Extensions._SignalExt][_SignalExtKeys._View][
          _ViewExtKeys._VpHeight
        ] = screen.vH;
        props[_Extensions._SignalExt][_SignalExtKeys._View][
          _ViewExtKeys._VpWidth
        ] = screen.vW;
        props[_Extensions._SignalExt][_SignalExtKeys._View][
          _ViewExtKeys._ColorDepth
        ] = screen.cd;
        props[_Extensions._SignalExt][_SignalExtKeys._View][
          _ViewExtKeys._SResolution
        ] = screen.sR;
      }
    };
    Analytics.prototype._addViewInfo = function (view, props) {
      props[_Extensions._SignalExt][_SignalExtKeys._View] = {};
      props[_Extensions._SignalExt][_SignalExtKeys._View][_SharedKeys._Title] =
        view.title;
      props[_Extensions._SignalExt][_SignalExtKeys._View][_SharedKeys._Type] =
        _PageViewType;
      props[_Extensions._SignalExt][_SignalExtKeys._View][_SharedKeys._Uri] = d(
        view.uri,
      );
      props[_Extensions._SignalExt][_SignalExtKeys._View][
        _SharedKeys._NameKey
      ] = d(view.name);
      props[_Extensions._SignalExt][_SignalExtKeys._View][_SharedKeys._Class] =
        view.viewClass;
      props[_Extensions._SignalExt][_SignalExtKeys._View][
        _ViewExtKeys._PreviousViews
      ] = this._previousView;
      if (view.referrer && isObject(view.referrer)) {
        props[_Extensions._SignalExt][_SignalExtKeys._Referrer] = {};
        props[_Extensions._SignalExt][_SignalExtKeys._Referrer][
          _ReferrerExtKeys._PageTitle
        ] = view.referrer.pageTitle;
        props[_Extensions._SignalExt][_SignalExtKeys._Referrer][
          _SharedKeys._Uri
        ] = d(view.referrer.uri);
      }
    ...
    Analytics.prototype._addAutocollectableFieldsToView = function (view) {
      view.name =
        view.name ||
        this._autoCollector._getPageNameFromPath(_getPathNameFromUri(view.uri));
      if (isDocumentObjectAvailable) {
        view.referrer =
          view.referrer || this._autoCollector._getReferrer(getDocument());
      }
    };
    Analytics.prototype._updateUserMapping = function (user) {
      ...
      if (localId && user.authId) {
        ...
        var storedMapping =
          JSON.parse(
            this._storageManager._getProperty(_UserMappingStorageKey),
          ) || {};
        if (
          !CoreUtils.hasOwnProperty(storedMapping, usermappingKey) ||
          time - parseInt(storedMapping[usermappingKey]) >
            7 * _DayToMilliseconds
        ) {
          storedMapping[usermappingKey] = time.toString();
          this._storageManager._setProperty(
            _UserMappingStorageKey,
            JSON.stringify(storedMapping),
          );
          var event_3 = {
